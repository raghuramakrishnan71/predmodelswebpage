...
> ${RESULTS_LOCATION}/evaluation_gr.csv

while IFS= read -r var
do

INPUT_REDUCED_TRAIN_FILE="${GREEDY_LOCATION}/${var}-gr-reduced_train"
INPUT_REDUCED_TEST_FILE="${GREEDY_LOCATION}/${var}-gr-reduced_test"
ACTUAL_VS_PREDICT_FILE="${GRPREDICT_LOCATION}/${var}-gr-reduced_test"
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-rbfreg.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-rbfreg" -append true -etime $DIFF -debug false -technique rbfreg
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-rbfnet.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-rbfnet" -append true -etime $DIFF -debug false -technique rbfnet
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-pacer.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-pacer" -append true -etime $DIFF -debug false -technique pacer
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-isor.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-isor" -append true -etime $DIFF -debug false -technique isor
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-lms.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-msq" -append true -etime $DIFF -debug false -technique msq
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-mlp.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-mlp" -append true -etime $DIFF -debug false -technique mlp
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-lr.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-lr" -append true -etime $DIFF -debug false -technique lr
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-slr.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-slr" -append true -etime $DIFF -debug false -technique slr
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-smo.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-smo" -append true -etime $DIFF -debug false -technique smo
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-dt.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-dt" -append true -etime $DIFF -debug false -technique dt
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-m5r.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-m5r" -append true -etime $DIFF -debug false -technique m5r
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-zr.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-zr" -append true -etime $DIFF -debug false -technique zr
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-m5p.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-m5p" -append true -etime $DIFF -debug false -technique m5p
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-ds.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-ds" -append true -etime $DIFF -debug false -technique ds
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-randfor.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-randfor" -append true -etime $DIFF -debug false -technique randfor
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-randtree.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-randtree" -append true -etime $DIFF -debug false -technique randtree
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-reptree.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-reptree" -append true -etime $DIFF -debug false -technique reptree
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-ibk.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-ibk" -append true -etime $DIFF -debug false -technique ibk
...
#java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-kstar.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-kstar" -append true -etime $DIFF -debug false -technique kstar
...
java $CLAZZ_PATH $JVM_MEM model.evaluation.ModelPerformance -i ${ACTUAL_VS_PREDICT_FILE}-lwl.csv -o ${RESULTS_LOCATION}/evaluation_gr.csv -p1 0.25 -p2 0.30 -label "${INPUT_REDUCED_TEST_FILE}-lwl" -append true -etime $DIFF -debug false -technique lwl
